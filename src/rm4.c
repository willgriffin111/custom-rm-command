...
int main(int argc, char *argv[]) {
    char *availableOptions[] = {"-f", "--force", "-r", "-R", "--recursive", "-d", "--dir", "-i", "-I", "--interactive=never", "-v", "--verbose", "--one-file-system", "--no-preserve-root", "--preserve-root", "--help", "--version", "--interactive=once", "--interactive=always"};
    ...
    bool verboseMode = false, interactiveMode = false, moreThanThreeInteractiveMode = false, removeDirectories = false, removeEmptyDirectories = false, forceMode = false, interactiveWhenNever = false, interactiveWhenOnce = false, interactiveWhenAlways = false, oneFileSystemMode = false, noPreserveRootMode = false, preserveRootMode = false, help = false, version = false;
    ...
    if (!removeDirectories && !removeEmptyDirectories) {
        ...
        if (removeDirectories) {
            ...
            int removalStatus = remove_directory(argv[i], oneFileSystemMode);
            if (verboseMode) {
